...
export default function WelcomePage() {
  ...
  return (
    <main className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-canvas px-margin_mobile py-16">
      ...
      {!selected ? (
        <div className="w-full max-w-3xl text-center">
          ...
          >
            Not sure yet? Explore every campus →
          </Link>
        </div>
      ) : (
        <div className="w-full max-w-xl text-center">
          <span className="inline-flex items-center gap-2 rounded-full border border-primary/20 bg-primary/10 px-3 py-1 font-label-md text-label-md text-primary">
            <Icon name="check_circle" fill className="text-[14px]" /> Campus matched
          </span>
          <div className="glass-card mt-6 rounded-[2rem] p-stack_lg">
            ...
            <p className="mx-auto mt-3 max-w-md font-body-md text-body-md text-on-surface-variant">
              {selected.blurb} Lessons, live rooms, the community, and your rank ladder
