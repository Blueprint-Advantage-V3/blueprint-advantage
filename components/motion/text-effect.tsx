...
/**
 * TextEffect — from motion-primitives.com (MIT).
 * Animates text in by character / word / line with a chosen preset.
...
export function TextEffect({
  ...
  const computedVariants = {
    ...
    item: createVariantsWithTransition(variants?.item || baseVariants.item, { duration: baseDuration }),
  };
